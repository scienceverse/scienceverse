...
```{r}
sig <- search_full_text(s, "significan[t|ce]")
...
```{r}
hypo <- search_full_text(s, "hypothes", section = "intro", refs = TRUE)
...
```{r}
hypo <- search_full_text(studies, "hypothesi", section = "intro")

hypo[, c("study", "section_class")]
```
