...
# Daniel I think you just need to update your version of reg. It does this now.
str(apathy_depression_study)
```
...
apathy_depression_study$analyses[[1]]$func %>% cat()

cat(" <- ")

apathy_depression_study$analyses[[1]]$code %>%
  paste(collapse= "\n") %>%
  cat()
```
