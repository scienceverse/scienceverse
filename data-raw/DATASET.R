...
study_demo <- study(name = "Kinship and Prosocial Behaviour (Demo)",
  ...
  add_method(id = "stimuli", description = "Shape–colour morphs were made by combining 40% of the shape and colour information from the self or non-self face with 60% of an unknown face to make the shape–colour morph. Note that the morph retains all of the unknown person’s hair colour and style. Shape-only morphs were made by combining 50% of the shape information from both faces and 100% of the colour information from the unfamiliar face.") %>%
